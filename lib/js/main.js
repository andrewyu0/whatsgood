...
app.controller('MainCtrl', function($scope, $http){
    ...
    $scope.allVenues = [];
      ...
      // Set on scope, add collectionName
      ...
      // $scope.fillmoreData = formattedFillmoreData;
 		});
      ...
      // $scope.indyData = formattedIndyData;
 		});
    ...
    $http.jsonp(a1015APIurl).success(function(data){
      ...
      // $scope.a1015data = formatted1015data;
    });
    ...
    $http.jsonp(warfieldAPIurl).success(function(data){
      ...
      $scope.warfieldData = formattedWarfieldData;
    });
